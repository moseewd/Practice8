...
namespace practice8
{
    class Program
    {
        ...
        static void ManualInput()
        {
            ...
            int k = Input.ReadInt("Введите размер клики, которую хотите найти: ", 1, n);
            ...
            if (foundCycle == string.Empty)
                Console.WriteLine($"Клика длиной {k} не найдена.");
            else
                Console.WriteLine($"Клика длиной {k} найдена: {foundCycle}");
            Console.ReadLine();
            Main();
        }
        ...
        static void RandomGraph()
        {
            ...
            int k = Input.ReadInt("Введите размер клики, которую хотите найти: ", 1, size);
